...
export class PerformanceAnalyzer implements IPerformanceAnalyzer {
   ...
   */
  async calculateDifficultyProgressTrend(timeframe: string, userId?: string): Promise<DifficultyTrendData[]> {
   ...
   */
  async calculateCompetencyGrowthTrend(timeframe: string, userId?: string): Promise<CompetencyTrendData[]> {
