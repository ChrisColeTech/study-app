...
export interface ISessionRepository
  extends IStandardCrudRepository<StudySession, StudySession, Partial<StudySession>>,
    IUserScopedRepository<StudySession> {
  /**
  ...
  findByUserId(
    userId: string,
    filters?: { limit?: number; lastEvaluatedKey?: any }
  ): Promise<StandardQueryResult<StudySession>>;
}
